        ...
        <div class="lecture-overview-item">
            <div class="lecture-overview-stats-wrap d-flex">
                ...
                <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                    <p class="pb-3">Get BUX certificate by completing entire course</p>
                    <a href="#" class="btn theme-btn theme-btn-transparent">BUX Certificate</a>
                </div><!-- end lecture-overview-stats-item -->
            </div><!-- end lecture-overview-stats-wrap -->
        </div><!-- end lecture-overview-item -->
        <div class="section-block"></div>
...
<div class="col-lg-6">
    <div class="cta-content-wrap">
        <h3 class="fs-18 font-weight-semi-bold">Students choose <a href="for-business.html" class="text-color hover-underline">BUX </a> to build in-demand career skills.</h3>
    </div>
</div><!-- end col-lg-6 -->
<div class="col-lg-6">
...
<div class="col-lg-3 responsive-column-half">
    <div class="footer-item">
        ...
        <ul class="generic-list-item pt-4">
            <li><a href="tel:+1631237884">+880 6161</a></li>
            <li><a href="mailto:support@wbsite.com">bracubux@g.bracu.ac.bd</a></li>
            <li>Merul Badda</li>
        </ul>
    </div><!-- end footer-item -->
</div><!-- end col-lg-3 -->
...
<div class="row align-items-center">
    <div class="col-lg-6">
        <p class="copy-desc">&copy; 2024 BRACU. All Rights Reserved. by <a >CSE470</a></p>
    </div><!-- end col-lg-6 -->
    <div class="col-lg-6">
