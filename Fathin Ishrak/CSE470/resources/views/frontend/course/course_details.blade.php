        ...
        <div class="row">
           <div class="col-lg-8 pb-5">
               <div class="course-details-content-wrap pt-90px">
                   ...
                   <div class="course-overview-card bg-gray p-4 rounded">
                       <h3 class="fs-16 font-weight-semi-bold">Curated for the <a href="for-business.html" class="text-color hover-underline">BRACU for Business</a> collection</h3>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       <h3 class="fs-20 font-weight-semi-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry</h3>
                       <p class="fs-15 pb-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                        <div class="pb-3">
                        ...
                        <a href="for-business.html" class="btn theme-btn theme-btn-sm">Try BRACU for Business</a>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
                        ...
                        <div class="media media-card">
                            ...
                            <div class="media-body">
                                ...
                                <div class="collapse" id="collapseMoreTwo">
                                    <p class="pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                    <p class="pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. <strong class="text-black font-weight-semi-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</strong>.
                                    </p>                                
                                </div>
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <div class="buy-for-team-container pt-4">
                                        ...
                                        <p class="lh-24 pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try BRACU for Business</a>
                                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="http://127.0.0.1:8000/become/instructor" class="btn theme-btn">Teach on BRACU <i class="la la-arrow-right icon ml-1"></i> </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <p class="pt-1 fs-14 lh-24">Lorem Ipsum is simply dummy text of the printing and typesetting industry
                        ...
                        <div class="form-group">
                            <div class="select-container w-auto">
                                <select class="select-container-select">
                                    ...
                                    <option value="3">BRACU Policy Violation</option>
