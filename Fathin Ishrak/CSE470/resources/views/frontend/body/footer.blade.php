            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item pt-4">
                        <li><a href="tel:+1631237884">02222-264051</a></li>
                        <li><a href="mailto:support@wbsite.com">	
                            info@bracu.ac.bd</a></li>
                        <li>Kha 224 Bir Uttam Rafiqul Islam Ave, Dhaka 1212</li>
                    </ul>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; 2024 BRACU All Rights Reserved. by <a href="https://techydevs.com/">CSE470</a></p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
