  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong></strong><img src="D:\XAMPP\htdocs\Pro1\CSE470\public\frontend\images\favicon.png" alt=""></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Brac Unniversity
               Email:buxbrac@g.bracu.ac.bd <br>
               Mob: 1245454545 <br>
