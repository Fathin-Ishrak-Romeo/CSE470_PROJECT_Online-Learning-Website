                          ...
                          <div class="col-lg-4 responsive-column-half">
                           ...
                           <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $course->label }}</h6>
                            ...
                            <p class="card-text"><a href=" ">{{ $course['user']['name'] }}</a></p>
                                      ...
                                      <div class="icon-element icon-element-sm shadow-sm cursor-pointer" title="Add to Wishlist" id="{{ $course->id }}" onclick="addToWishList(this.id)" ><i class="la la-heart-o"></i></div>                                      </div>
                                  </div><!-- end card-body -->
                              </div><!-- end card -->
                          </div><!-- end col-lg-4 --> 
